...
return [
    ...
    'urlManager' => [
        ...
        'rules' => require(__DIR__.'/../config/routing.php'),
    ],
    'view' => [
        'renderers' => [
            'twig' => [
                ...
                'cachePath' => null,
                'functions' => require(__DIR__.'/../config/twig_functions.php'),
                'globals' => require(__DIR__.'/../config/twig_globals.php'),
            ],
        ],
    ],
    'authManager' => [
    ...
    'search' => [
        ...
        'dsn' => 'mysql:host=db_server;port=9306;',
...
//    ],
    ...
    'chat' => [
        ...
        'baseUrl' => 'chat.vicesisterstest.tk',
