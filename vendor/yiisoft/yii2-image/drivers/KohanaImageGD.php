 ...
 */
class KohanaImageGD extends KohanaImage {
    ...
    public static function check()
    {
        ...
        $functions = array(
            ImageGD::IMAGEROTATE,
            ImageGD::IMAGECONVOLUTION,
            ImageGD::IMAGEFILTER,
            ImageGD::IMAGELAYEREFFECT
        );
        foreach ($functions as $function)
        {
            ImageGD::$_available_functions[$function] = function_exists($function);
        }
        ...
        {
            throw new ErrorException('ImageGD requires GD version :required or greater, you have :version',
    ...
    /**
     * Runs [ImageGD::check] and loads the image.
     *
    ...
    {
        if (empty(ImageGD::$_available_functions[ImageGD::IMAGEROTATE]))
        {
    ...
    {
        if (empty(ImageGD::$_available_functions[ImageGD::IMAGECONVOLUTION]))
        {
            throw new ErrorException('This method requires :function, which is only available in the bundled version of GD',
    ...
    {
        if (empty(ImageGD::$_available_functions[ImageGD::IMAGEFILTER]))
        {
            throw new ErrorException('This method requires :function, which is only available in the bundled version of GD',
    ...
    {
        if (empty(ImageGD::$_available_functions[ImageGD::IMAGELAYEREFFECT]))
        {
            throw new ErrorException('This method requires :function, which is only available in the bundled version of GD',
