 ...
 * @method mixed get($key) Get the string value of a key
 * @method mixed incr($key) Increment the value of a key
 * @method mixed hdel($key,$field) Delete hash field
 * @method mixed hset($key,$field,$value) Set hash field value
 * @method mixed hvals($key) Return all hash values
 * @method mixed hincrby($key,$field) Increment the value of a hash field
 * @method mixed hget($key,$field) Get hash field value
 * @method mixed lpush($key,$value) Push value to list
 * @method mixed lrange($key,$start,$end) Get range values from list
 * @method mixed ltrim($key,$start,$end) Trim list from start to end
 * @method mixed del($key) Delete key
 * @method mixed expire($key,$time) Set expiration of a key
